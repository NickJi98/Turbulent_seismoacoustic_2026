...
## Velocity models
vel_list=(vel_model_fit vel_model_site)
vel_file=${vel_list[$SLURM_ARRAY_TASK_ID]}

## Output directory
out_dir="./outputs/my_run${SLURM_ARRAY_TASK_ID}"
mkdir -p "$out_dir"
...
## Run MATLAB script
matlab -batch "vel_file='${vel_file}.csv'; model_main"
